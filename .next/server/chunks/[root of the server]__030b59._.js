...
"[project]/src/types/index.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
const TaskSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].object({
...
"[project]/src/middlewares/validateRequest.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/types/index.js [app-route] (ecmascript)");
;
class validateRequest {
    static async validateTaskRequest(request) {
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TaskSchema"].safeParse(body);
            if (response.success) {
                return null;
            }
        } catch (error) {
...
"[project]/src/app/api/task/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/lib/prisma.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middlewares$2f$validateRequest$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/middlewares/validateRequest.js [app-route] (ecmascript)");
...
async function GET() {
    try {
        const task = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].task.findMany();
...
async function POST(request) {
    try {
        ...
        const newTask = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].task.create({
            data: {
                title,
                description
            }
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__030b59._.js.map